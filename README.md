...
| Complete deployment | Same-host API paths and one Scheduler-crash recovery case are exercised; Worker/store/message-bus failures, WebUI integration and cross-node deployment remain incomplete |
