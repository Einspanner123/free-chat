...
| Completed-prefix control | Engine-owner updates on A5000/A4000 protect matching completed-request blocks, clear protection on Resume and reject stale ownership/sequence; recycled blocks are reported absent. Gateway/Harness control transport is still pending |
